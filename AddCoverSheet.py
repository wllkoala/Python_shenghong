...
class AddCoverSheet():
    ...
    def write_data(self, data, rev):
        ...
        if data[7].upper() == "Y":
            ...
            ws.cell(14, 4).value = data[5] + "_R" + rev
